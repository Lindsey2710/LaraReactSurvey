...
export default function SurveyView() {
  ...
  const onImageChoose = (ev) => {
    ...
    if (file) {
      ...
      setSurvey({ ...survey, image: file, image_url: imageUrl });
    }
  };
          ...
          <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
            ...
            <div>
              ...
              <div className="mt-1 flex items-center">
                ...
                <button
                  type="button"
                  className="relative ml-5 rounded-md border border-gray-400 bg-white py-2 px-3 text-sm
                font-medium leading-4 text-gray-700 shadow-md hover:bg-gray-100 focus:outline-none
            ...
            <div className="col-span-6 sm:col-span-3">
              ...
              <input
                ...
                className="mt-1 block w-full rounded-md border-gray-400 shadow-md focus:border-indigo-50
            ...
            <div className="col-span-6 sm:col-span-3">
              ...
              <textarea
                ...
                placeholder="Describe your ssurvey"
